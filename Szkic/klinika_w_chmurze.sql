...
CREATE TABLE surgery (
    ...
    surgery_room         int NOT NULL,
    `date`            date NOT NULL,
    name_of_surgery      varchar(150) NOT NULL,
    personel_personel_id int NOT NULL,
...
INSERT INTO ward (ward_id, ward_name, building, floor, phone_number, int_of_free_beds, maximum_capacity, hospital_hospital_id) VALUES (1, 'Oddział Chirurgiczny', 'A', 1, '+48 22 111 11 11', 10, 20, 3);
INSERT INTO ward (ward_id, ward_name, building, floor, phone_number, int_of_free_beds, maximum_capacity, hospital_hospital_id) VALUES (2, 'Oddział Internistyczny', 'B', 2, '+48 22 222 22 22', 15, 25, 3);
...
INSERT INTO ward (ward_id, ward_name, building, floor, phone_number, int_of_free_beds, maximum_capacity, hospital_hospital_id)
